...
function FaqItem({question, answer}){
    ...
    return(
        <div className="accordion-item">
            <div className="question"><a className="accordion-link" onClick={changeVisibility}><h3>{question}</h3>{visibility ? (<ion-icon name="remove-outline"></ion-icon>) : (<ion-icon name="add-outline"></ion-icon>)}</a></div>
